# @summary 1.7.1.2 Ensure local login warning banner is configured properly (Scored)
#
# Description:
...
class cis_linux_2_0_0::login_banner_config_1_7_1_2 (
  Boolean $apply_cis_control = lookup('cis_linux_2_0_0::login_banner_config_1_7_1_2::apply_cis_control')
) {

  if $apply_cis_control {
    file { '/etc/issue':
      ensure => present,
      source  => 'puppet:///modules/cis_linux_2_0_0/issue',
      owner   => 'root',
      group   => 'root',
      mode    => '0644',
    }
